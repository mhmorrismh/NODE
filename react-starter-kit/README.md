...
A modern, production-ready SaaS starter template for building full-stack React applications using React Router v7, Convex, Clerk, and Polar.sh. Ready for Vercel deployment with built-in Google Gemini 2.5 Flash AI chat capabilities.
...
# Google Gemini Configuration (for AI chat)
...
- `GOOGLE_GENERATIVE_AI_API_KEY` - Google Gemini API key for chat features
...
- `@ai-sdk/google` & `ai` - AI chat capabilities with Google Gemini
...
Built with ❤️ using React Router v7, Convex, Clerk, Polar.sh, and Google Gemini.